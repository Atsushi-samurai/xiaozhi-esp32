...
public:
    ...
    /**
     * Fetch current OTA connection settings and recreate the protocol without
     * checking or installing a firmware update. Safe to call from any task.
     * Requests outside idle state are ignored so an active conversation is not
     * interrupted.
     */
    void ReloadProtocolConfiguration();
